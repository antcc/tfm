...
@generated_exts = qw(nav snm acn acr alg aux code ist fls glg glo gz gls glsdefs idx ind lof lot out thm toc tpt wrt run.xml nav snm synctex  synctex.gz mw bcf synctex(busy));
